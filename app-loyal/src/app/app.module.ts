...
@NgModule({
  /*definir las vitas que formar parte del m�dulo */
  declarations: [
    AppComponent,
  ...
  /*export de otro m�dulos que importamos */
  imports: [
  BrowserModule,
    AppRoutingModule,
    FormsModule,
  ...
  /*servcios que se pueden acceder desde cualuier parte de la aplicaci�n */
  providers: [],
  /*componente inical de la aplicaci�n */
